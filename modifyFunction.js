...
export function originalFunction(num) {
  return num * 4; // Пример оригинальной функции, которая умножает аргумент на 4
}

export function modifyFunction(originalFunc, multiplier) {
  return function(num) {
